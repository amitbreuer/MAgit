...
public class NewRepositoryServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MagitManager magitManager = userManager.getMagitManager();
        try {
            magitManager.ValidateAndLoadXMLRepositoryFromUploadedFile(currentUserName,fileContent);
            out.println(gson.toJson("The repository was uploaded succesully"));

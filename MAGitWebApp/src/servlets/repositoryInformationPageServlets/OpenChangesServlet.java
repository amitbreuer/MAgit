...
public class OpenChangesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Delta delta = user.getMagitManager().GetWCDelta();
        delta.setDeltaComponentsNamesFromMainFolder(Constants.usersDirectoryPath + File.separator + username + File.separator + repositoryName);
